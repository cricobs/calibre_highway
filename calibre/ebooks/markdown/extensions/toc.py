...
class TocTreeprocessor(Treeprocessor):
    ...
    def replace_marker(self, root, elem):
        ...
        for (p, c) in self.iterparent(root):
            ...
            # would causes an enless loop of placing a new QstandarditemmodelContent
            # inside previously generated QstandarditemmodelContent.
...
class TocExtension(Extension):
    ...
    def __init__(self, *args, **kwargs):
        self.config = {
            "marker": ['[QstandarditemmodelContent]',
                       'Text to find and replace with Table of Contents - '
                       'Set to an empty string to disable. Defaults to "[QstandarditemmodelContent]"'],
            "title": ["",
                      "Title to insert into QstandarditemmodelContent <div> - "
