...
OptionRecommendation(name='max_toc_links',
            ...
            help=_('Maximum number of links to insert into the QstandarditemmodelContent. Set to 0 '
               'to disable. Default is: %default. Links are only added to the '
            'QstandarditemmodelContent if less than the threshold number of chapters were detected.'
                )
        ),
...
OptionRecommendation(name='duplicate_links_in_toc',
            recommended_value=False, level=OptionRecommendation.LOW,
            help=_('When creating a QstandarditemmodelContent from links in the input document, '
...
OptionRecommendation(name='markup_chapter_headings',
    ...
    help=_('Detect unformatted chapter headings and sub headings. Change '
           'them to h2 and h3 tags.  This setting will not create a QstandarditemmodelContent, '
