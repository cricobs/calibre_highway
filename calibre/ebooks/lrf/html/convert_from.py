...
class HTMLConverter(object):
    ...
    def __init__(self, book, fonts, options, logger, paths):
        ...
        self.extra_toc_entries = []  # : QstandarditemmodelContent entries gleaned from semantic information
        self.image_memory = []
        self.id_counter = 0
        ...
        def add_toc_entry(text, target):
            ...
            if target.parent is not None and \
               hasattr(target.parent, 'objId'):
                ...
                self.log.debug(_("Cannot add link %s to QstandarditemmodelContent")%ascii_text)
