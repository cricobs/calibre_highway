...
class TOCWidget(Widget, Ui_Form):
    ...
    def __init__(self, parent, get_option, get_help, db=None, book_id=None):
        ...
        self.opt_level1_toc.set_msg(_('Level &1 QstandarditemmodelContent (XPath expression):'))
        self.opt_level2_toc.set_msg(_('Level &2 QstandarditemmodelContent (XPath expression):'))
        self.opt_level3_toc.set_msg(_('Level &3 QstandarditemmodelContent (XPath expression):'))
        try:
